...
object RenderDefinition {
  implicit val renderDefinitionDecoder: Decoder[RenderDefinition] = deriveDecoder[RenderDefinition]
  implicit val renderDefinitionEncoder: Encoder[RenderDefinition] = deriveEncoder[RenderDefinition]
}

object ScaleOpt {
  implicit val scaleOptEncoder: Encoder[ScaleOpt] = Encoder.encodeString.contramap[ScaleOpt](_.repr)
  implicit val scaleOptDecoder: Decoder[ScaleOpt] = Decoder.decodeString.emap { str =>
...
object ClippingOpt {
  implicit val clipOptEncoder: Encoder[ClippingOpt] = Encoder.encodeString.contramap[ClippingOpt](_.repr)
  implicit val clipOptDecoder: Decoder[ClippingOpt] = Decoder.decodeString.emap { str =>
    str.toLowerCase match {
